...
void bubble_sort(int** matrice, int** matrice2, int rows, int cols)
{
    std::cout << "Выберите, как будут расположены числа в строках:" << "/n" << "1 - по убыванию" << "/n" << "2 - по возрастанию";
    int z;
    std::cin >> z;
    int p = choice();
    switch (z)
